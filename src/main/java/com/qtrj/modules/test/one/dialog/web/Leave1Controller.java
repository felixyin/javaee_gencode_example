 ...
 */
package com.qtrj.modules.test.one.dialog.web;
...
import com.qtrj.modules.test.one.dialog.service.Leave1Service;
...
public class Leave1Controller extends BaseController {
	...
	public String list(Leave1 leave1, Model model) {
		...
		System.out.println("o6677777777666k");
		testJrebel();
	...
	public Map<String, Object> data(Leave1 leave1, HttpServletRequest request, HttpServletResponse response,
			Model model) {
	 ...
	 * 查看，增加，编辑请假表单表单页面
	 */
	@RequiresPermissions(value = { "test:one:dialog:leave1:view", "test:one:dialog:leave1:add",
			"test:one:dialog:leave1:edit" }, logical = Logical.OR)
