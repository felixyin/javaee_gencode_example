 ...
 */
package com.qtrj.modules.sys.web;
...
import com.qtrj.core.security.shiro.session.SessionDAO;
import com.qtrj.core.servlet.ValidateCodeServlet;
import com.qtrj.core.web.BaseController;
import com.qtrj.modules.iim.entity.MailBox;
import com.qtrj.modules.iim.entity.MailPage;
import com.qtrj.modules.iim.service.MailBoxService;
import com.qtrj.modules.oa.entity.OaNotify;
import com.qtrj.modules.oa.service.OaNotifyService;
import com.qtrj.modules.sys.security.FormAuthenticationFilter;
	...
	public String index(HttpServletRequest request, HttpServletResponse response) {
		...
		if(UserUtils.getMenuList().size() == 0){
			...
			if(MobileUtils.checkAgentIsMobile(request.getHeader("User-Agent"))){//如果是移动，默认使用左侧菜单，显示效果较好
				indexStyle = "ani";
			}else{//如果是pc端，默认使用qtrj.properties中的配置项，jp横向菜单，ani左侧菜单
