...
<head>
	...
	<script type="text/javascript">
        ...
        function getUploadFileValues() {
            var list = $("#qtrj_file_list .list-item .download-this");
            var files = [];
        ...
        function getUploadFileNames() {
            var list = $("#qtrj_file_list .list-item label");
            var files = [];
            for(var i=0; i < list.length; i++){
        ...
        function getUploadFileSizes() {
            var list = $("#qtrj_file_list .list-item p.size");
            var files = [];
            for(var i=0; i < list.length; i++){
                files.push($(list[i]).text());
            }
...
<body class="bg-white">
			...
			<div id="uploader" class="uploader">
				...
				<!--用来存放文件信息-->
				<div id="qtrj_file_list" class="uploader-list">
					<div  class="file-desc">
						<p>上传文件到这里</p>
					</div>
				</div>
